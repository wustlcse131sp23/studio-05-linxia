...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		Color blueRGB = new Color(0, 109, 219);
		StdDraw.setPenColor(blueRGB);
		StdDraw.filledCircle(x, y, radius*3/4);
		
		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		Color redRGB = new Color(146, 0, 0);
		StdDraw.setPenColor(redRGB);
		StdDraw.filledCircle(x, y, radius/2);
		

		// Yellow ring with 1.0/4.0 the radius
		// suggested rgb values: 255, 255, 109
		Color yellowRGB = new Color(255, 255, 109);
		StdDraw.setPenColor(yellowRGB);
	 ...
	 * 
	 * @param values an array of integers
	 * @return mean of the values in array
	 */
